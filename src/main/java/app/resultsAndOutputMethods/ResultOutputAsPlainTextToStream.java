...
/**
 * Class that gives to an {@link OutputStream} the results has Plain Text
 * {@code String}s, each result is presented in a different line and is defined
 * as in {@link Object#toString()}.
 * 
 * @see 
...
public class ResultOutputAsPlainTextToStream extends ResultOutputMethodToStream
{
	...
	/**
	 * The constructor for a {@code ResultOutputAsPlainTextToStream}.
	 * 
	 * @param out
	 ...
	 * results will be replaced with a space (" "). This method makes use of the

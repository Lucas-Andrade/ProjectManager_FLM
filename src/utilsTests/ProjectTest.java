...
public class ProjectTest {
	...
	public void testToString() {
		...
		Project proj1 = new Project("Proj1", local, leader, new Team(), (long)11);
		Project proj2 = new Project("Proj2", local, leader, new Team(), (long)22);
		Project proj3 = new Project("Proj3", local, leader, new Team(), (long)33);
		Project proj4 = new Project("Proj4", local, leader, new Team(), (long)44);

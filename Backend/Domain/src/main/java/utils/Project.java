...
public class Project implements IProject {
	...
	/**
	 * The manager of the project. This field is volatile.
	 */
	...
	/**
	 * Method that will allow a Sub{@code Project} to be removed from the
	 * {@code this} {@code ProjectsContainer}. If the {@code Project} doesn't
	 * exist on {@code this} {@code Project#projectsContainer} no project will
	 * be removed and the method will return false. If successful this method
	 * also removes the removed Sub{@code Project}'s name from the
	 * {@link NameTester} ({@see NameTester#removeName(String)}; {@see
	...
	/**
	 * Verifies if the {@code Project} passed as parameter has the same
	 * properties as {@code this}.
	 * 
	 * @param worker
	 * @return true if the {@code Project} passed as parameter has the same
	 *         properties as {@code this}
	 * @return false if the {@code Project} passed as parameter has not the same
	 *         properties as {@code this}
	 */
	...
	/**
	 * Verifies if the {@code Project} passed as parameter has the same team as
	 * {@code this}.
	 * 
	 * @param worker
	 * @return true if the {@code Project} passed as parameter has the same team
	 *         as {@code this}
	 * @return false if the {@code Project} passed as parameter has not the same
	 *         team as {@code this}
	 */
